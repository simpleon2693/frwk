	    ...
	    <div class="contents">
	    	 <form id="frmRsmRgstr" autocomplete="off" method="post" action="/psn/resume/actionRegistration.do">
		        <article class="box" id="cont_01">
		            ...
		            <div class="cont">
		                <div class="row">
		                    <input type="text" class="w-100" placeholder="제목" name="rsuSjt" caption="제목" value="소방공무원 경력 30년의 준비된 소방안전관리자 입니다."/>
		                    <div class="check">
		                        <div class="check__item">
		                            <input type="checkbox" id="checkRsuPubiYn" name="rsuPubiYn" value="0" checked="checked"/>
		                            <p>
		            ...
		            <div class="cont">
		                ...
		                <div class="row">
		                    <label class="add-input">
		                        <input type="text" class="w-100" placeholder="서울|경기" disabled name="deslyWkpl" caption="희망 근무지역">
		                        <button type="button" class="add-btn">추가하기</button>
		                    </label>
		                </div>
		                <div class="row">
		                    <label class="add-input">
		                        <input type="text" class="w-100" placeholder="설비" disabled name="jobList" caption="희망 직무">
		                        <button type="button" class="add-btn">추가하기</button>
		                    </label>
		                </div>
		                <div class="row">
		        ...
		        <article class="box" id="cont_11">
		            ...
		            <div class="cont">
		                <div class="row">
		                    <textarea class="w-100 h-120" placeholder="자기소개서" name="slfintro">만나서 반갑습니다.</textarea>
		                </div>
		            </div>
