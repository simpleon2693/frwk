	    ...
	    <div class="contents">
	    	 <form id="frmRsmRgstr" autocomplete="off" method="post" action="/psn/resume/actionRegistration.do">
		        <article class="box" id="cont_01">
		            ...
		            <div class="cont">
		                <div class="row">
		                    <input type="text" class="w-100" placeholder="제목" name="rsuSjt" caption="제목"/>
		                    <div class="check">
		                        <div class="check__item">
		                            <input type="checkbox" id="checkRsuPubiYn" name="rsuPubiYn" value="0"/>
		                            <p>
		                            	<label for="checkRsuPubiYn">이력서 공개</label>
		                            </p>
		                        </div>
		                        <div class="check__item">
		                            <input type="checkbox" id="checkPhnPubiYn" name="phnPubiYn" value="1"/>
		                            <p>
		                ...
		                <div class="divide">
		                    ...
		                    <div class="info">
		                        <div class="row">
		                            ...
		                            <input type="text" class="w-360" placeholder="이름" id="psnNm" name="nm" caption="이름"/>
		                        </div>
		                        <div class="row">
		                            <p class="label">
		                            	<label for="psnBirthdd">생년월일</label>
		                            </p>
		                            <input type="text" class="w-360" placeholder="생년월일" id="psnBirthdd" name="birthdd" caption="생년월일"/>
		                        </div>
		                        <div class="row">
		                            <p class="label">성별</p>
		                            <div class="check">
		                        ...
		                        <div class="row">
		                            <p class="label">주소</p>
		                            <input type="text" class="w-279" placeholder="우편번호" id="psnZipcd" name="zipcd" readonly />
		                            <button type="button" class="primary_btn submit_btn" onclick="findAddress()">주소찾기</button>
		                            <input type="text" class="w-100-label double-input" placeholder="주소" id="psnAddr" name="addr" caption="주소" readonly />
		                            <input type="text" class="w-100-label double-input" placeholder="주소 상세" id="psnDetlAddr" name="detlAddr" caption="주소 상세"/>
		                        </div>
		                        <div class="row">
		                            <p class="label">
		            ...
		            <div class="cont">
		                ...
		                <div class="row">
		                    <label class="add-input">
                                ...
                                <input type="text" class="w-100" name="jobCdNm" caption="직급/직책"
		                ...
		                <div class="row">    
		                	<label class="add-input">
                                <input type="hidden" name="jobList" />
                                <input type="text" class="w-100" name="jobListNm" caption="직무"
		        ...
		        <article class="box" id="cont_04">
		            ...
		            <div class="cont">
		                <div class="row">
		                    <input type="text" class="w-314" placeholder="자격증명" name="licenNm" caption="자격증명">
		                    <input type="text" class="w-150 ml-10" placeholder="발행처" name="puco" caption="발행처">
		                    <input type="text" class="w-150 ml-10" placeholder="취득월 (ex:202210)" name="acqYm" caption="취득일자">
		        ...
		        <article class="box" id="cont_10">
		            ...
		            <div class="cont">
		                <div class="row">
		                    <div class="check">
		                        <div class="check__item">
		                            <input type="checkbox" id="checkRepaYn" name="repaYn" value="0"/>
		                            <p>
		                            	<label for="checkRepaYn">보훈대상</label>
		                            </p>
		                        </div>
		                        <div class="check__item">
		                            <input type="checkbox" id="checkFnempYn" name="fnempYn" value="0"/>
		                            <p>
		                            	<label for="checkFnempYn">취업보호 대상</label>
		                            </p>
		                        </div>
		                        <div class="check__item">
		                            <input type="checkbox" id="checkFipinYn" name="fipinYn" value="0"/>
		                            <p>
		        ...
		        <article class="box" id="cont_11">
		            ...
		            <div class="cont">
		                <div class="row">
		                    <textarea class="w-100 h-120" placeholder="자기소개서" name="slfintro"></textarea>
		                </div>
		            </div>
