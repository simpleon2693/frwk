...
<%--  메인 컨텐츠   --%>
    <main class="main">
        <form name="frmJobOpen" method="post" action="/com/jobopen/actionRegistration.do" >
            <input type="hidden" name="jobOpenSeq" />
                ...
                <div class="contents">
                    <article class="box">
                        <div class="box__top">
                            ...
                            <button type="button" class="primary_btn_line" id="loadPrevJobopen"> 이전 공고 불러오기</button>
                        </div>
                        <div class="cont">
                            <div class="row">
                        ...
                        <div class="cont">
                            ...
                            <div class="row divide">
                                ...
                                <div class="check divide-select">
                                    ...
                                    <div class="check__item">
                                        <input type="radio" name="qualification.sexCd" caption="성별" value="SEX003"/>
                                        <p>여자</p>
                                    </div>
                            ...
                            <div class="row">
                                <label class="add-input">
                                    <input type="text" class="w-100" placeholder="우대직무"
                                           name="qualification.prefJobList"
                        ...
                        <div class="cont">
                            <div class="row">
                                ...
                                <div class="input-check">
                                    <input type="checkbox" name="workCondition.salDecideAfterInterview" caption="면접후결정"/>
                                    <p>면접 후 결정</p>
                                </div>
                            </div>
                            <div class="row divide">
                                <p class="label">해외지원여부</p>
                                <div class="check divide-select">
                                    <div class="check__item">
                                        <input type="radio" name="ovsYn" caption="해외지원여부" value="N" checked/>
                                        <p>국내</p>
                                    </div>
                                    <div class="check__item">
                                        <input type="radio" name="ovsYn" caption="해외지원여부" value="Y"/>
                                        <p>해외</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <button type="button" class="primary_btn submit_btn" id="openKakaoMap">위치 보기</button>                            </div>
